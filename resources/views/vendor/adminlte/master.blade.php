...
@yield('title_postfix', config('adminlte.title_postfix', ''))</title>
    ...
    @if(config('adminlte.plugins.datepicker'))
        <!-- Datepicker -->
        <link rel="stylesheet" href="{{ asset('vendor/adminlte/plugins/datepicker/bootstrap-datepicker.css') }}">
    @endif

    @if(config('adminlte.plugins.iziToast'))
        <!-- iziToast -->
        <link rel="stylesheet" href="{{ asset('vendor/adminlte/plugins/iziToast/iziToast.min.css') }}">
    @endif
...
@if(config('adminlte.plugins.datepicker'))
    ...
    <script src="{{ asset('vendor/adminlte/plugins/datepicker/bootstrap-datepicker.ja.js') }}"></script>
@endif
...
@if(config('adminlte.plugins.iziToast'))
    <!-- iziToast -->
    <script src="{{ asset('vendor/adminlte/plugins/iziToast/iziToast.min.js')}}"></script>
    @include('adminlte::partials.session_message')
@endif
